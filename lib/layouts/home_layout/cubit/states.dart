...
class HorseImageSuccessState extends HorseStates{}
class HorseImageErrorState extends HorseStates{}
...
class AddHorseProductSuccessfulState extends HorseStates{}
class AddHorseProductErrorState extends HorseStates{
  final String error;
  AddHorseProductErrorState(this.error);
}
