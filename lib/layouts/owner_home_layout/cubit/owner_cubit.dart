...
class OwnerCubit extends Cubit<OwnerState> {
  ...
  String? specificValueChoose;

  void onChangeSpecificDropDownButton(newValue) {
    specificValueChoose = newValue;
    emit(DropDownButtonState());
  }

  String? nationlityValueChoose;

  void onChangeNationalityDropDownButton(newValue) {
    nationlityValueChoose = newValue;
    emit(DropDownButtonState());
  }

  String? sourceValueChoose;

  void onChangeSourceDropDownButton(newValue) {
    sourceValueChoose = newValue;
    emit(DropDownButtonState());
  }
  ...
  void addTypeCollection(String section) {
    FirebaseFirestore.instance
        ...
        .collection('sections')
        .doc('$section')
        .set({'name': section, 'secId': section}).then((value) {
  ...
  void getDoctors({required String secId}) {
    docData = [];
    FirebaseFirestore.instance
        .collection('owners')
        .doc(oId)
  ...
  void getHorseDetailsData({required horseId, required secId}) {
    print(oId);
