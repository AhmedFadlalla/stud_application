...
class CommentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    DoctorCubit.get(context).getComments(postId: postId!);
                ...
                children: [
                  Expanded(
                    child:ListView.separated(
                        itemBuilder: (context,index)=>buildCommentItem(context,DoctorCubit.get(context).comments[index]),
                        separatorBuilder:(context,index)=> myDivider(),
                        itemCount: DoctorCubit.get(context).comments.length),
                  ),
                  Row(
                    children: [
                      Expanded(
                      ...
                      IconButton(
                          onPressed: (){
                            DoctorCubit.get(context).addComment(
                                postId!,
                                textController.text,
  ...
  Widget buildCommentItem(context,CommentModel model)=> Padding(
    ...
    child: Row(
      ...
      children: [
        CircleAvatar(
          backgroundImage: NetworkImage(DoctorCubit.get(context).doctorModel!.image),
          radius: 20.0,
